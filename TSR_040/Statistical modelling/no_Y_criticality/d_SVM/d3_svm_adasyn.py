...
# d) apply ADASYN and fit svc with tuned parameter
...
svm_fit = svm_tuned.fit(x_train_sd_adasyn, y_train_adasyn)
...
plt.plot(fpr, tpr, marker='.', label='SVM and AUC='+str(correct_auc))
