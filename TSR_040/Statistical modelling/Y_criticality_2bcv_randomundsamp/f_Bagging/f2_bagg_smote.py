...
# d) Apply SMOTE, Randomundersampler with tuned parameters and fit bagg
...
bagg_fit = bagging_classifier.fit(x_train_resampled, y_train_resampled)
...
plt.title('Variable importance Bagging on SMOTE rebalanced dataset')
plt.show()