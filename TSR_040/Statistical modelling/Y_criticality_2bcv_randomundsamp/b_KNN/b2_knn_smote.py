...
# d) Apply SMOTE, Randomundersampler and fit knn with tuned parameters
...
x_train_resampled, y_train_resampled = undersampler.fit_resample(x_train_sd_smote, y_train_smote)
