...
# d) Apply ADASYN, Randomundersampler and fit svc with tuned parameter
...
x_train_resampled, y_train_resampled = undersampler.fit_resample(x_train_sd_adasyn, y_train_adasyn)
print(y_train_resampled.value_counts())
svm_tuned = SVC(C=tuned_par[2], kernel=tuned_par[5], degree=tuned_par[4], coef0=tuned_par[3], probability=True, random_state=123)
svm_fit = svm_tuned.fit(x_train_resampled, y_train_resampled)
