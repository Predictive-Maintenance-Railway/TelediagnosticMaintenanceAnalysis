...
# e) Apply SMOTE, Randomundersampler and fit boosting with tuned parameters
...
plt.title('Variable importance Boosting on SMOTE rebalanced dataset')

# and Partial dependence plot
features = list(range(x_train.shape[1]))
fig, ax = plt.subplots(figsize=(20, 8))
display = PartialDependenceDisplay.from_estimator(boost_fit, x_train_smote, features, ax=ax, grid_resolution=20)
plt.show()