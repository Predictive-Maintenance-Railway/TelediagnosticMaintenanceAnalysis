...
# d) Apply ADASYN, Randomundersampler and fit logistic with tuned parameters
...
logistic_tuned = LogisticRegression(penalty='l1', solver='liblinear', max_iter=1000, C=tuned_par[2], random_state=123)
log_fit = logistic_tuned.fit(x_train_resampled, y_train_resampled)
