...
'''
# plot alpha vs n.of nodes and alpha vs f1 score:
...
plot_tree(tree_fit, rounded=True, feature_names=x_train.columns, class_names=['0','1'], max_depth=max_depth_pruned, fontsize=13)
plt.title('Pruned decision tree on imbalance dataset')
plt.show()