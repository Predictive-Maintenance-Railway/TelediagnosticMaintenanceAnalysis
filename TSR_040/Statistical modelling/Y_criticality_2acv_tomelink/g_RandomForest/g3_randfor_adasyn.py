...
# d) Apply ADASYN, tomeklinks and fit tree with tuned parameters
...
randfor_tuned = RandomForestClassifier(n_estimators=500, oob_score=True, n_jobs=-1, random_state=123, max_features=tuned_par[2])
randfor_fit = randfor_tuned.fit(x_train_adasyn_tomek, y_train_adasyn_tomek)
