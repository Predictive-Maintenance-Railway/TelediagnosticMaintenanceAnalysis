...
grid_search = GridSearchCV(randfor, param_grid, cv=cv, scoring=make_scorer(threshold_f1_scorer, needs_proba=True), n_jobs=-1)
...
plt.title('Variable importance RandForest with moving threshold')